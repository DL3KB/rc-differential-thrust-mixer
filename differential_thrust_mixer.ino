...
const float mix_strength = .5; // value from 0 (no mix) to 1 (100%) for the mix strength. May eventually set this value from another switch/channel on the receiver
...
float throttle, yaw, modifyer = 1000;
float yaw_pct;
